...
function InputFormPage() {
  ...
  const normalizeSilos = (silosInput) =>
    silosInput.map((silo, index) => ({ ...silo, silo_id: `S${index + 1}` }));
  ...
  const removeArrayRow = (section, index) => {
    ...
    if (section === "silos") {
      ...
      const nextLayers = payload.layers.filter((layer) =>
        siloIds.has(layer.silo_id),
      );
      setPayload((prev) => ({
        ...prev,
        silos: normalized,
  ...
  const removeObjectEntry = (section, keyToRemove) => {
    const entries = Object.entries(payload[section] || {}).filter(
      ([key]) => key !== keyToRemove,
    );
    updatePayload(section, Object.fromEntries(entries));
  };
    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-stone-300 bg-stone-50 p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
        <div className="mb-3 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={addSiloRow}
            className="rounded-md bg-amber-800 px-3 py-1 text-sm text-white hover:bg-amber-700"
          >
            + Add Row
          </button>
        </div>
          ...
          <table className="min-w-full text-sm">
            ...
            <tbody>
              {silos.map((silo, index) => (
                <tr
                  key={`silo-${index}`}
                  className="border-b border-stone-200 dark:border-zinc-800"
                >
                  <td className="px-2 py-2">
                    <input
                      value={silo.silo_id}
                      readOnly
                      className="w-20 rounded border border-stone-300 bg-stone-200 px-2 py-1 dark:border-zinc-600 dark:bg-zinc-700"
                    />
                  </td>
                  <td className="px-2 py-2">
                    <input
                      type="number"
                      value={silo.capacity_kg}
                      onChange={(e) =>
                        updateArrayField(
                          "silos",
                          index,
                      ...
                      className="w-32 rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
                    />
                  </td>
                  <td className="px-2 py-2">
                    <input
                  ...
                  <td className="px-2 py-2">
                    <button
                      type="button"
                      onClick={() => removeArrayRow("silos", index)}
                ...
                >
                  <td className="px-2 py-2">
                    <select
                      ...
                      className="w-24 rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
                    >
                      {silos.map((silo) => (
                  ...
                  <td className="px-2 py-2">
                    <input
                      ...
                      className="w-28 rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
                    />
                  </td>
                  <td className="px-2 py-2">
                    <input
                      value={layer.supplier}
                      onChange={(e) =>
                        updateArrayField(
                          "layers",
                          index,
                  ...
                  <td className="px-2 py-2">
                    <button
                      type="button"
                      onClick={() => removeArrayRow("layers", index)}
                      className="rounded border border-red-300 px-2 py-1 text-xs text-red-700 dark:border-red-900 dark:text-red-300"
                    >
                      Remove
                    </button>
                ...
                >
                  ...
                  <td className="px-2 py-2">
                    <input
                      ...
                      className="w-20 rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
                    />
                  </td>
                  <td className="px-2 py-2">
                    <input
                  ...
                  <td className="px-2 py-2">
                    <button
                      type="button"
                      onClick={() => removeArrayRow("suppliers", index)}
                      className="rounded border border-red-300 px-2 py-1 text-xs text-red-700 dark:border-red-900 dark:text-red-300"
                    >
                      Remove
                    </button>
      ...
      <section className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="rounded-2xl border border-stone-300 bg-stone-50 p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
          <div className="mb-3 flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => addObjectEntry("target_params", "new_param")}
              className="rounded-md bg-amber-800 px-3 py-1 text-sm text-white hover:bg-amber-700"
            >
              + Add Row
            </button>
            ...
            {Object.entries(payload.target_params || {}).map(([key, value]) => (
              <div key={key} className="grid grid-cols-[1fr_140px_auto] gap-2">
                <input
                  ...
                  className="rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
                />
                <input
                  type="number"
                  value={value}
                ...
                <button
                  type="button"
                  onClick={() => removeObjectEntry("target_params", key)}
                  className="rounded border border-red-300 px-2 py-1 text-xs text-red-700 dark:border-red-900 dark:text-red-300"
                >
                  Remove
                </button>
        ...
        <div className="rounded-2xl border border-stone-300 bg-stone-50 p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
          <div className="mb-3 flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => addObjectEntry("weights", "new_weight")}
              className="rounded-md bg-amber-800 px-3 py-1 text-sm text-white hover:bg-amber-700"
            >
              + Add Row
            </button>
            ...
            {Object.entries(payload.weights || {}).map(([key, value]) => (
              <div key={key} className="grid grid-cols-[1fr_140px_auto] gap-2">
                <input
                  value={key}
                  onChange={(e) =>
                    updateObjectEntry("weights", key, e.target.value, value)
                  }
                  className="rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
                />
                <input
                ...
                <button
                  type="button"
                  onClick={() => removeObjectEntry("weights", key)}
                  className="rounded border border-red-300 px-2 py-1 text-xs text-red-700 dark:border-red-900 dark:text-red-300"
                >
                  Remove
                </button>
      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        <label className="rounded-2xl border border-stone-300 bg-stone-50 p-4 text-sm shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
          ...
          <input
            type="number"
            value={payload.sigma_m}
            onChange={(e) => updatePayload("sigma_m", Number(e.target.value))}
        ...
        <label className="rounded-2xl border border-stone-300 bg-stone-50 p-4 text-sm shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
          ...
          <input
            type="number"
            value={payload.steps}
            onChange={(e) => updatePayload("steps", Number(e.target.value))}
            className="mt-1 w-full rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
          />
        </label>
        <label className="rounded-2xl border border-stone-300 bg-stone-50 p-4 text-sm shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
          ...
          <select
            value={payload.mode}
            onChange={(e) => updatePayload("mode", e.target.value)}
            className="mt-1 w-full rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
          >
        ...
        <div className="rounded-2xl border border-stone-300 bg-stone-50 p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="text-sm">
              ...
              <input
                type="number"
                value={payload.material.rho_bulk_kg_m3}
                onChange={(e) =>
                  updatePayload("material", {
                    ...payload.material,
                    rho_bulk_kg_m3: Number(e.target.value),
                  })
                }
                className="mt-1 w-full rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
              />
            ...
            <label className="text-sm">
              ...
              <input
                type="number"
                value={payload.material.grain_diameter_m}
                onChange={(e) =>
                  updatePayload("material", {
                    ...payload.material,
                    grain_diameter_m: Number(e.target.value),
                  })
                }
                className="mt-1 w-full rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
              />
        ...
        <div className="rounded-2xl border border-stone-300 bg-stone-50 p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
          ...
          <div className="grid grid-cols-3 gap-3">
            <label className="text-sm">
              ...
              <input
                type="number"
                value={payload.beverloo.C}
                onChange={(e) =>
                  updatePayload("beverloo", {
                    ...payload.beverloo,
            ...
            <label className="text-sm">
              ...
              <input
                type="number"
                value={payload.beverloo.g_m_s2}
                onChange={(e) =>
                  updatePayload("beverloo", {
                    ...payload.beverloo,
                    g_m_s2: Number(e.target.value),
                  })
                }
                className="mt-1 w-full rounded border border-stone-300 bg-white px-2 py-1 dark:border-zinc-600 dark:bg-zinc-900"
              />
